...
mediakeys = gtable.join(
  ...
  awful.key({}, "Print",
    function()
      awful.spawn.with_shell("xfce4-screenshooter -f -s ~/stuff/image/screenshot/")
    end,
    {description = "took screenshot of entire screen", group = "screenshot"}),

  awful.key({ shiftkey }, "Print",
    function()
      awful.spawn.with_shell("xfce4-screenshooter -w -s ~/stuff/image/screenshot/")
    end,
    {description = "took screenshot of focused window", group = "screenshot"}),

  awful.key({ ctrlkey }, "Print",
    function()
      awful.spawn.with_shell("xfce4-screenshooter -r -s ~/stuff/image/screenshot/")
    end,
